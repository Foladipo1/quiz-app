...
function getHintText(quizId: string): string {
    if (quizId === "mbta-b-branch") {
        return "Hint: type the full station name.";
    }

    if (quizId === "first-20-elements") {
        return "Hint: use the American spellings.";
    }

    return "Answers are checked without case sensitivity.";
}
